                    ...
                    <form class="form-horizontal"  id="galleryForm" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="files" class="col-sm-2 control-label">Kapak Fotoğrafı</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required name="name" id="name" type="text" class="form-control" placeholder="ADI" >
                                </div>
                            </div>
...
@push("customJs")
     <script>
         ...
         $("#submitButton").click(function () {
             ...
             var url = "{{route("backend.gallery.update")}}";
