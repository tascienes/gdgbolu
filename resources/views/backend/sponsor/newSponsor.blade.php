                    ...
                    <form class="form-horizontal" id="blogForm" enctype='multipart/form-data'>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img src="@if(isset($sponsor)){{asset($sponsor->cover_image)}} @endif" alt="" id="coverImageShow">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="name" type="text" class="form-control" id="" placeholder="ADI" value="@if(isset($sponsor)) {{$sponsor->name}} @endif">
                                </div>
                            </div>
...
@push("customJs")
    ...
    <script>
        ...
        $("#submitButton").click(function () {
                    @if(isset($sponsor))
            var url ="{{route("backend.sponsors.update", ["id" => $sponsor->id])}}";
                    @else
            var url = "{{route("backend.sponsors.create")}}";
                    @endif
